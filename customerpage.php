  ...
  if (isset($_POST['submit'])) {
    if (empty($_POST['username']) || empty($_POST['password'])) {
      ...
      $query = mysqli_query($conn,"select * from customer where CUS_PASSWORD='$password' AND USERNAME='$username'");
...
<html>
  <head>
    ...
    <link href="hcss/icon.css" rel="stylesheet">
  ...
  <body>
    ...
    <p><h2><strong><center>CUSTOMER LOGIN</center></h2></strong></p> 
    <br><br>  
    <div class="container">  
      <div class="row">
